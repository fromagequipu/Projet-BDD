...
def extract():
    ...
    parametre_df = resultat[["cdparametre", "libminparametre","cdunitereference","refqual"]] # Ici on peut avoir des duplicas car par étudiant de base mais inscription la même année et le même prix
